...
class GetAppliedApplicationsUseCase @Inject constructor(
    ...
    suspend  fun invokeToGetAppliedApplicationsRemotely(applicantId:String):Pair<List<Applications>, Response<Boolean>> = applicationsRepo.getAppliedApplications(applicantId)
